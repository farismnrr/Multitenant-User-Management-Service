...
describe('POST /auth/internal/invitations & Register with Code', () => {
    ...
    async function getInvitationCode() {
         const response = await axios.post(`${BASE_URL}/auth/internal/invitations`, {}, {
    ...
    test('Scenario 1: Generate Invitation Code', async () => {
        ...
        const code = typeof response.data === 'string' ? response.data : response.data.code || response.data;
